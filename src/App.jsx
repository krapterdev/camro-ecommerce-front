...
const CompanyProfile = lazy(() => import("./pages/website/CompanyProfile"));
const DirectorMessage = lazy(() => import("./pages/website/DirectorMessage"));
const ContactUs = lazy(() => import("./pages/website/ContactUs"));
const CategoryPage = lazy(() => import("./pages/website/CategoryPage"));
const ProductDetailPage = lazy(() => import("./pages/website/ProductDetailPage"));
