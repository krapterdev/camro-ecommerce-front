                ...
                <div className="">
                  ...
                  <div className="card-body text-center pt-7 mt-3">
                    ...
                    <p className="mb-0 px-lg-6">
                      We use premium materials like stainless steel and
                      non-stick coatings, tested for lasting performance and
                      quality.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4" data-animate="fadeInUp">
                <div className="">
                  ...
                  <div className="card-body text-center pt-7 mt-3">
                    ...
                    <p className="mb-0 px-lg-6">
                      All Grace formulations adhere to strict purity standards
                      and will never contain harsh or toxic ingredients
                    </p>
                  </div>
                </div>
              </div>
