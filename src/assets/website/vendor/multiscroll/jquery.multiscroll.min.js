    ...
    $.fn.multiscroll = function(options) {
        ...
        */
        ...
        function navMouseEnterHandler() {
            ...
            $('<div className="multiscroll-tooltip ' + options.navigationPosition +'">' + tooltip + '</div>').hide().appendTo($(this)).fadeIn(200);
        }
        ...
        */
        function addTableClass(element){
            element.addClass('ms-table').wrapInner('<div className="ms-tableCell" style="height: ' + getTableHeight(element) + 'px" />');
        }
        ...
        */
         function displayWarnings(){
            ...
            if(!isOK){
                ...
                showError('error', '../../github.com/alvarotrigo/multiScroll.js#options');
            }
        }
