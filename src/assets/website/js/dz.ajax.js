...
function contactForm()
{
	...
	$(".dzForm").on('submit',function(e)
	{
		...
		$('.dzFormMsg').html('<div className="gen alert dz-alert alert-success">Submitting..</div>');
		...
		$.ajax({
			...
			success: function(dzRes){
				if(dzRes.status == 1){
					msgDiv = '<div className="gen alert dz-alert alert-success">'+dzRes.msg+'</div>';
				}
				
				if(dzRes.status == 0){
					msgDiv = '<div className="err alert dz-alert alert-danger">'+dzRes.msg+'</div>';
				}
