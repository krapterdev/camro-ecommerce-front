      ...
      jQuery(".mfp-gallery").length > 0 &&
        ...
        jQuery(".mfp-video").length > 0 &&
          jQuery(".mfp-video").magnificPopup({
            ...
            iframe: {
              markup:
                '<div className="mfp-iframe-scaler"><div className="mfp-close"></div><iframe className="mfp-iframe" frameborder="0" allowfullscreen></iframe><div className="mfp-title">Some caption</div></div>',
            },
            callbacks: {
...
d = function () {
  if (jQuery("#masonry, .masonry").length > 0) {
    var $masonry = jQuery("#masonry, .masonry");
    var gutter = $masonry.data("gutter") === undefined ? 0 : parseInt($masonry.data("gutter"));
    var columnWidth = $masonry.attr("data-column-width");
    columnWidth = columnWidth !== undefined ? parseInt(columnWidth) : "";
    ...
    $masonry.imagesLoaded(function () {
      $masonry.isotope({
        ...
        filter: jQuery(".filters li:first").attr("data-filter") // filter only first li items by default
      });
    });
      ...
      $("input[name='demo_vertical2']").length > 0 &&
        ...
        $(".quantity-input").length > 0 &&
          jQuery(".quantity-input").TouchSpin({
            verticalbuttons: !0,
            verticalupclass: "iconly-Light-Search",
            verticaldownclass: "fa-solid fa-minus",
          });
    },
    x = function () {
      ...
      document.querySelectorAll(".word-rotate").forEach((e, t) => {
        ...
        i.forEach((t, i) => {
          $(e)
            ...
            .append(
              '<span className="text__char" style="--char-rotate :' +
                i * n +
                'deg">' +
                t +
                "</span>"
